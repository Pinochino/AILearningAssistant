    ...
    <div className="space-y-6">
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Tạo môn học mới và phân công giáo viên
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="flex items-center gap-3">
                <Avatar className="h-8 w-8">
                  <AvatarFallback className="text-xs">
                    {subject.teacher.name.split(' ').map(n => n[0]).join('').toUpperCase()}
                  </AvatarFallback>
                </Avatar>
                <div>
              ...
              <div className="flex justify-between items-center pt-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => navigateTo('edit-subject')}
                  >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold">
              {mockSubjects.reduce((sum, s) => sum + s.studentCount, 0)}
            </p>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold">
              {mockSubjects.reduce((sum, s) => sum + s.quizCount, 0)}
            </p>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold">
              {mockSubjects.reduce((sum, s) => sum + s.flashcardCount, 0)}
            </p>
