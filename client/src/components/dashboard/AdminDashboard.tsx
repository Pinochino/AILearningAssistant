    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Quản lý và theo dõi hoạt động của nền tảng AI Learning Assistant</p>
        </div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Thống kê người dùng, quiz và flashcard theo tháng</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width='100%' height={300}>
              <BarChart data={monthlyData}>
                ...
                <Bar dataKey='flashcards' fill='#f59e0b' name='Flashcard' />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Số lượng học sinh theo từng môn học</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width='100%' height={300}>
              <PieChart>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Thông tin chi tiết về từng môn học trong hệ thống</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div key={subject.name} className='flex items-center justify-between p-4 border rounded-lg'>
                <div className='space-y-1'>
                  <div className='flex items-center gap-3'>
                    ...
                    <Badge variant='secondary'>{subject.students} học sinh</Badge>
                    <Badge variant='outline'>{subject.teachers} GV</Badge>
                  </div>
                  <div className='flex items-center gap-4 text-sm text-muted-foreground'>
                    <span>{subject.quizzes} quiz</span>
                    <span>•</span>
                    <span>Tỷ lệ hoàn thành: {subject.completion}%</span>
                  </div>
                </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        <Card className='cursor-pointer hover:shadow-md transition-shadow'>
          <CardContent className='p-6 text-center'>
            ...
            <p className='text-sm text-muted-foreground'>Thêm, chỉnh sửa thông tin giáo viên và học sinh</p>
          </CardContent>
        </Card>
        ...
        <Card className='cursor-pointer hover:shadow-md transition-shadow'>
          <CardContent className='p-6 text-center'>
            ...
            <p className='text-sm text-muted-foreground'>Thiết lập môn học mới và phân quyền</p>
          </CardContent>
        </Card>
        ...
        <Card className='cursor-pointer hover:shadow-md transition-shadow'>
          <CardContent className='p-6 text-center'>
            ...
            <h3 className='font-medium mb-1'>Báo cáo chi tiết</h3>
            <p className='text-sm text-muted-foreground'>Xem báo cáo và thống kê chi tiết</p>
          </CardContent>
        </Card>
      </div>
