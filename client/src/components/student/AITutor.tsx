...
const mockChatHistory: ChatMessage[] = [
  {
    id: '1',
    type: 'ai',
    content: 'Xin chào! Tôi là AI Tutor của bạn. Tôi có thể giúp bạn giải đáp thắc mắc về các môn học, giải bài tập, và hướng dẫn học tập. Bạn muốn học gì hôm nay?',
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const aiMessage: ChatMessage = {
        ...
        type: 'ai',
        content: 'Tôi đang xử lý câu hỏi của bạn. Đây là một câu trả lời mẫu từ AI tutor. Trong thực tế, câu trả lời sẽ được tạo bởi mô hình AI dựa trên nội dung câu hỏi của bạn.',
        timestamp: new Date(),
        subject: selectedSubject !== 'all' ? selectedSubject : undefined,
      };
