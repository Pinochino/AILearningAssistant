    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-4'>
          <Button variant='outline' size='sm' onClick={() => navigateTo('subjects')} className='gap-2'>
            <ChevronLeft className='h-4 w-4' />
            Quay lại
          </Button>
          <div>
            <h1 className='text-2xl font-bold'>Tài liệu môn học</h1>
            <p className='text-muted-foreground'>Tài liệu, bài giảng và tài nguyên học tập</p>
          </div>
        </div>
      </div>
          ...
          <Card key={doc.id} className='hover:shadow-md transition-shadow'>
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='flex gap-2'>
                <Button size='sm' className='flex-1 gap-2' onClick={() => handleView(doc.id)}>
                  <Eye className='h-4 w-4' />
                  Xem
                </Button>
                <Button size='sm' variant='outline' className='flex-1 gap-2' onClick={() => handleDownload(doc.id)}>
      ...
      {filteredDocuments.length === 0 && (
        <Card>
          <CardContent className='flex flex-col items-center justify-center py-12'>
            ...
            <p className='text-muted-foreground text-center'>Không có tài liệu nào phù hợp với bộ lọc của bạn.</p>
          </CardContent>
        </Card>
      )}
    </div>
