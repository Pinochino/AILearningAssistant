    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Các thông báo quan trọng từ nhà trường và giáo viên</CardDescription>
        </CardHeader>
        <CardContent>
          <div className='space-y-4'>
            {mockAnnouncements.map((announcement) => (
              <div
                key={announcement.id}
                className={`p-4 border rounded-lg ${!announcement.isRead ? 'bg-blue-50 border-blue-200' : ''}`}
              >
                <div className='flex items-start justify-between'>
                  <div className='flex-1'>
                    ...
                    <div className='flex items-center gap-4 text-xs text-muted-foreground'>
                      ...
                      <span>•</span>
                      <span>{new Date(announcement.timestamp).toLocaleDateString('vi-VN')}</span>
                    </div>
                  </div>
                  <div className='flex items-center gap-1'>
                    <Button variant='ghost' size='sm'>
