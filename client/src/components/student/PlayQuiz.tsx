...
const PlayQuiz = () => {
    ...
    const formatTime = (seconds: number, showRemaining: boolean = false) => {
        if (!quiz) return '0:00';
        const displaySeconds = showRemaining ? Math.max(0, (quiz.duration || 30) * 60 - seconds) : seconds;
                            ...
                            <div className="flex justify-center gap-4 mt-4">
                                ...
                                <div className="rounded-xl p-6 text-center border bg-blue-50 border-blue-200 shadow-sm w-28 h-28 flex flex-col justify-center">
                                    <div className="flex items-center justify-center gap-2 mb-2">
                                        ...
                                        <div className="text-xl font-semibold text-blue-700">{formatTime(timer, false)}</div>
                                    </div>
