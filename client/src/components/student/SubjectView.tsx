          ...
          {mockChapters.map((chapter) => (
            <Card key={chapter.id} className={!chapter.isUnlocked ? 'opacity-60' : ''}>
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <div className='flex items-center gap-4 text-sm text-muted-foreground mt-1'>
                      <span>
                        {chapter.completedLessons}/{chapter.lessons} bài học
                      </span>
                      <span>•</span>
                      <span>
                        {chapter.completedQuizzes}/{chapter.quizzes} quiz
                      </span>
                      <span>•</span>
                      <span>
                        {chapter.studiedFlashcards}/{chapter.flashcards} flashcard
                      </span>
                    </div>
                  </div>
              ...
              <CardContent className='space-y-4'>
                ...
                {!chapter.isUnlocked && (
                  <p className='text-sm text-muted-foreground'>Hoàn thành chương trước để mở khóa</p>
                )}
              </CardContent>
            </Card>
          ))}
        ...
        <TabsContent value='activities' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Các hoạt động học tập bạn đã thực hiện</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {mockRecentActivities.map((activity) => (
                  <div key={activity.id} className='flex items-center gap-4 p-3 border rounded-lg'>
                    ...
                    <div className='text-right'>
                      {activity.type === 'quiz' && activity.score && <Badge variant='default'>{activity.score}%</Badge>}
                      {activity.type === 'flashcard' && activity.progress && (
                        <Badge variant='secondary'>{activity.progress}%</Badge>
                      )}
                      {activity.type === 'lesson' && activity.completed && <Badge variant='default'>Hoàn thành</Badge>}
                    </div>
                  </div>
                ))}
              </div>
        ...
        <TabsContent value='tasks' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Các bài tập và kiểm tra cần hoàn thành</CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-4'>
