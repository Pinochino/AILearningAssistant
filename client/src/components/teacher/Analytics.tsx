...
export function Analytics() {
  ...
  const filteredStudentPerformance =
    selectedSubject === 'all'
      ...
      : mockStudentPerformance.filter(
          (s) => s.subject === mockSubjectStats.find((sub) => sub.id === selectedSubject)?.name
        )
    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Phân tích hiệu quả giảng dạy và tiến độ học tập của sinh viên</p>
        </div>
        ...
        <TabsContent value='quizzes' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Thống kê chi tiết về các bài kiểm tra và quiz</CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-4'>
        ...
        <TabsContent value='flashcards' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Thống kê về việc sử dụng và hiệu quả của flashcard</CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-4'>
