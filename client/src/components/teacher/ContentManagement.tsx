    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Quản lý tài liệu, quiz và flashcard cho các môn học</p>
        </div>
          ...
          <Dialog open={isUploadDialogOpen} onOpenChange={setIsUploadDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Thêm tài liệu học tập cho sinh viên</DialogDescription>
              </DialogHeader>
          ...
          >
            ...
            <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
              <DialogHeader>
                ...
                <DialogDescription>Tạo quiz</DialogDescription>
              </DialogHeader>
              <div className='space-y-6'>
                <div className='space-y-2'>
          ...
          >
            ...
            <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
              <DialogHeader>
                ...
                <DialogDescription>Tạo bộ flashcard cho sinh viên ôn tập</DialogDescription>
              </DialogHeader>
              <div className='space-y-6'>
                <div className='space-y-2'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
        ...
        <Card>
          <CardContent className='p-4 text-center'>
            <div className='text-2xl font-bold'>{mockDocuments.reduce((sum, doc) => sum + doc.downloads, 0)}</div>
