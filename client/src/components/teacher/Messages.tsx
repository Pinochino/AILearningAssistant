...
const mockMessages = [
  ...
  },
  {
    ...
    content: 'Thầy ơi, em muốn đăng ký tham gia lớp Toán học 12A1. Em đã học qua chương trình cơ bản và muốn học nâng cao.',
        ...
        <Dialog open={isComposeOpen} onOpenChange={setIsComposeOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Gửi tin nhắn hoặc thông báo cho sinh viên
              </DialogDescription>
            </DialogHeader>
        ...
        <div className="lg:col-span-2 space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Danh sách tin nhắn và yêu cầu từ sinh viên
              </CardDescription>
            </CardHeader>
            <CardContent className="p-0">
              <div className="space-y-1">
                {filteredMessages.map((message) => (
                  <div
                    key={message.id}
                    className={`p-4 border-b cursor-pointer hover:bg-muted/50 ${selectedMessage === message.id ? 'bg-muted' : ''
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {message.priority === 'high' && (
                            <Badge variant="destructive" className="text-xs">Ưu tiên cao</Badge>
                          )}
                          {!message.isRead && (
                        ...
                        <div className="flex items-center gap-4 text-xs text-muted-foreground mt-2">
                          ...
                          {message.attachments.length > 0 && (
                            <span>📎 {message.attachments.length} tệp đính kèm</span>
                          )}
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Các thông báo đã gửi cho sinh viên
              </CardDescription>
            </CardHeader>
            <CardContent>
