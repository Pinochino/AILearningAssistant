...
import { Search, Plus, MessageSquare, FileText, BarChart3, Users, Clock, Trophy, Target, Calendar } from 'lucide-react'
    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Theo dõi tiến độ và quản lý học sinh trong các lớp học</p>
        </div>
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='space-y-2'>
                <div className='flex justify-between text-sm'>
                  ...
                  <span>
                    {classData.completedAssignments}/{classData.totalAssignments}
                  </span>
                </div>
                <Progress value={(classData.completedAssignments / classData.totalAssignments) * 100} className='h-2' />
              </div>
            </CardContent>
          </Card>
        ))}
      ...
      <Dialog open={isMessageDialogOpen} onOpenChange={setIsMessageDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Gửi tin nhắn tới {selectedStudent?.name}</DialogDescription>
          </DialogHeader>
          <div className='space-y-4'>
            <div className='space-y-2'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea id='message' placeholder='Nhập nội dung tin nhắn...' rows={4} />
            </div>
            <div className='flex justify-end gap-2'>
              <Button variant='outline' onClick={() => setIsMessageDialogOpen(false)}>
                Hủy
              </Button>
              <Button onClick={() => setIsMessageDialogOpen(false)}>Gửi tin nhắn</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
