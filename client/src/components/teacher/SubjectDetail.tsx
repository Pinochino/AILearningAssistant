...
const mockPendingStudents = [
  {
    ...
    message: 'Em muốn tham gia lớp học để nâng cao kiến thức toán học'
  },
  {
    id: '5',
    name: 'Hoàng Văn E',
    ...
    message: 'Em đã học qua chương trình cơ bản và muốn học nâng cao'
  },
  {
    id: '6',
    name: 'Nguyễn Thị F',
                    ...
                    <div className='flex items-start justify-between'>
                      <div className='flex items-center gap-3'>
                        ...
                        <div className='space-y-1'>
                          ...
                          <p className='text-sm text-muted-foreground'>
                            Đăng ký: {new Date(student.requestDate).toLocaleDateString('vi-VN')}
                          </p>
                          <p className='text-sm mt-2 p-2 bg-muted/50 rounded'>"{student.message}"</p>
                        </div>
                      </div>
                      <div className='flex gap-2'>
                        <Button size='sm' onClick={() => handleApproveStudent(student.id)} className='gap-1'>
            ...
            <DialogContent>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex justify-end gap-2'>
                  ...
                  <Button onClick={() => setIsCreateChapterOpen(false)}>Tạo Chương</Button>
                </div>
              </div>
            </DialogContent>
          </Dialog>
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <div className='flex items-center gap-4 text-sm text-muted-foreground mt-1'>
                      ...
                      <span>•</span>
                      <span>{chapter.flashcards} flashcard</span>
                    </div>
                  </div>
                  <Badge variant='secondary'>{chapter.completion}%</Badge>
                </div>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  ...
                  <Dialog open={isUploadDocOpen} onOpenChange={setIsUploadDocOpen}>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>Upload tài liệu cho {chapter.title}</DialogDescription>
                      </DialogHeader>
                      <div className='space-y-4'>
                        <div className='space-y-2'>
                        ...
                        <div className='flex items-center space-x-2'>
                          <Checkbox id='public' />
                          <Label htmlFor='public'>Công khai cho tất cả học sinh</Label>
                        </div>
                        <div className='flex justify-end gap-2'>
                          <Button variant='outline' onClick={() => setIsUploadDocOpen(false)}>
                            Hủy
                          </Button>
                          <Button onClick={() => setIsUploadDocOpen(false)}>Upload</Button>
                        </div>
                      </div>
                    </DialogContent>
                  </Dialog>
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <div className='space-y-1'>
                        ...
                        <div className='flex items-center gap-4 text-sm text-muted-foreground'>
                          ...
                          <span>•</span>
                          <span>Điểm TB: {student.quizScore}</span>
                          <span>•</span>
