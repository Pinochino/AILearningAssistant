...
import Progress from '../multilingual_translation/Progress';
import AudioPlayer from '../speech_recognition/AudioPlayer';
...
const TextToSpeechClient = () => {
  ...
  // We use the `useEffect` hook to setup the worker as soon as the `TextToSpeechClient` component is mounted.
  useEffect(() => {
    if (!worker.current) {
