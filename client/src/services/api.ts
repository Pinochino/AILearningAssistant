...
export const classApi = {
  async getAll(params?: { page?: number; limit?: number; subject?: string; teacherId?: string; dayOfWeek?: number }) {
  ...
  async approveEnrollment(enrollmentId: string) {
    return apiRequest<{ success: boolean; message?: string }>(`/enrollments/${enrollmentId}/approve`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      }
...
export const studentApi = {
  async getEnrolledClasses(studentId: string) {
    return apiRequest<ClassEnrollment[]>(`/students/${studentId}/enrollments?status=approved`, { method: 'GET' })
  },

  async getClassSchedule(studentId: string) {
    return apiRequest<{ classes: Class[] }>(`/students/${studentId}/schedule`, { method: 'GET' })
  },
  ...
  async getUpcomingAssignments(studentId: string) {
    ...
    >(`/students/${studentId}/assignments/upcoming`, { method: 'GET' })
  }
}
