...
import { connectMongo } from './configs/mongoose.js'
...
async function bootstrap() {
  ...
  try {
    // Connect to MongoDB
    const mongoUri =
      process.env.MONGO_URL || 'mongodb+srv://dtumailm_db_user:HhQXlU8VUKU6TRgV@cluster0.tb9bh1l.mongodb.net/ala'
    ...
    io.use(async (socket, next) => {
      try {
        ...
        socket.data.user = {
          ...
          role: 'user', // TODO: map từ roles nếu cần
